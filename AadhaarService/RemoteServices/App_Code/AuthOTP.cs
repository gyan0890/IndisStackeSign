...
namespace AllAuthClass
{
    public class AuthOTP
    {
        ...
        public string GenAuthXML_OTP(string aadharNo = "", string publicKey = "", string pid = "", string txn = "")
        {
        ...
        public string GenOTPXML(string aadharNo)
        {
            ...
            SetAttribute(XDOtp, Root, "ts","2015-07-10T12:33:16");
            SetAttribute(XDOtp, Root, "ver", "1.0");
            SetAttribute(XDOtp, Root, "txn", "fhg65465454fdgfgrahj");
            SetAttribute(XDOtp, Root, "aspId", "ASPDIETY");
            SetAttribute(XDOtp, Root, "uid",aadharNo.Trim());
            XmlNode Rad1 = Root.AppendChild(XDOtp.CreateElement("Signature"));
            SetAttribute(XDOtp, Rad1, "xmlns", "http://www.w3.org/2000/09/xmldsig#");
            XmlNode Rad2 = Rad1.AppendChild(XDOtp.CreateElement("SignedInfo"));
            XmlNode Rad3 = Rad2.AppendChild(XDOtp.CreateElement("CanonicalizationMethod"));
            SetAttribute(XDOtp, Rad3, "Algorithm", "http://www.w3.org/TR/2001/REC-xml-c14n-20010315");
            XmlNode Rad4 = Rad2.AppendChild(XDOtp.CreateElement("SignatureMethod"));
            SetAttribute(XDOtp, Rad4, "Algorithm", "http://www.w3.org/2000/09/xmldsig#rsa-sha1");
            XmlNode Rad5 = Rad2.AppendChild(XDOtp.CreateElement("Reference"));
            SetAttribute(XDOtp, Rad5, "URI", "");
            XmlNode Rad6 = Rad5.AppendChild(XDOtp.CreateElement("Transforms"));
            XmlNode Rad7 = Rad6.AppendChild(XDOtp.CreateElement("Transform"));
            SetAttribute(XDOtp, Rad7, "Algorithm", "http://www.w3.org/2000/09/xmldsig#enveloped-signature");
            XmlNode Rad8 = Rad6.AppendChild(XDOtp.CreateElement("Transform"));
            SetAttribute(XDOtp, Rad8, "Algorithm", "http://www.w3.org/2001/10/xml-exc-c14n#");
            XmlNode Rad9 = Rad5.AppendChild(XDOtp.CreateElement("DigestMethod"));
            SetAttribute(XDOtp, Rad9, "Algorithm", "http://www.w3.org/2000/09/xmldsig#sha1");
            XmlNode Rad10 = Rad5.AppendChild(XDOtp.CreateElement("DigestValue"));
            Rad10.InnerXml = "0fircy1Ie03VMnoWj5PmH2p6zpM=";
            XmlNode Rad11 = Rad1.AppendChild(XDOtp.CreateElement("SignatureValue"));
            ...
            XmlNode Rad12 = Rad1.AppendChild(XDOtp.CreateElement("KeyInfo"));
            XmlNode Rad13 = Rad12.AppendChild(XDOtp.CreateElement("X509Data"));
            XmlNode Rad14 = Rad13.AppendChild(XDOtp.CreateElement("X509SubjectName"));
            ...
            XmlNode Rad15 = Rad13.AppendChild(XDOtp.CreateElement("X509Certificate"));
